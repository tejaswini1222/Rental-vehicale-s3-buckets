<%-- 
    Document   : online
    Created on : 29 Feb, 2024, 9:49:06 AM
...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <div  class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>Make the most of the every moment with our trusted vehicle rental service !!!!!! </h2>
                  </div>
               </div>
            </div>
            <div class="container">
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img">
                        <div class="about_box">
                           <h3 colspan='5'>Online Pay</h3>
                           
                           <form>
                               <table border="2" align="center" width="400px" height="200px"  style="background-color: #ffffff">
                                   <tbody>
                                       <tr>
                                           <td>Booking Id</td>
                                           <td><%=mn1%></td>
                               ...
                               %>
                                       ...
                                       <tr><td><img src="images/GooglePay_QR.png" width="200" height="200"/></td>
                                           </tr>
                                       
                                          <tr>
                                           <td colspan="2" align="center"><input type="submit" value="PAY" name="PAY" /></td>
      ...
      if(bd!=null && bd!="" && fnm!=null && fnm!="" && mob!=null && mob!="" && vtype!=null && vtype!="")
       {
      String str2="insert into online(id,booking_date,Full_name,mobile_number,vehicle_type,kms,rent,type)values("+mn1+",'"+bd+"','"+fnm+"',"+mob+",'"+vtype+"',"+kms+","+amt+",'"+type+"')";
