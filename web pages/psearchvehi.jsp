<%-- 
    Document   : psearchvehi
    Created on : 7 Oct, 2023, 11:14:40 AM
...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <div  class="about">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img">
                        <div class="about_box">
                           <h3 colspan='5'>Search Vehical</h3>
                                     ...
                                     <tbody>
                                       <tr>
                                             ...
                                             <td><select name="vehicom">
                                                ...
                                                <td colspan="2">Oil Type</td>
                                                <td colspan="2"><select name="otyp">
                                                   <option></option>
                                                   <option>Disel</option>
                                       ...
                                       <tr>
                                           <td colspan="10" align="center"><input type="submit" value="Search" name="Search" /></td>
                                           
                                              
                                       </tr>
                                       <tr>
                                           <td>Id</td><td>Company Name</td><td>Vehical Type</td><td>seats</td><td>Model Type</td><td>oil Type</td><td>Rent of vehicle</td><td>Unit</td><td>Image Path</td>
                                       </tr>
                               <%
                               String vehicom= request.getParameter("vehicom");
                               String com=null;
                               String vtype=null;
                               int id=0;
                               String modt=null;
       ...
       String otyp= request.getParameter("otyp");
       Statement st=con.createStatement();
       String str="select * from avehiclinfo where Vehical_company='"+vehicom+"' and Oil_type='"+otyp+"'";
   ...
   while(rs.next())
   {
       ...
       //String img1="images/"+img;
                               ...
                               %>
                               <tr><td><%=id%></td><td><%=com%></td><td><%=vtype%></td><td><%=seat%></td><td><%=modt%></td><td><%=oiltype%></td><td><%=rent%></td><td>unit</td><td><img src="<%=img%>"/>
                                       </td>
                                       <td align="center"><input type="button"name="Booking" value="Booking"style="background-color: cornflowerblue;font-weight: bold;color: white;"onclick="editRecord(<%=rs.getInt(1)%>)"/></td></tr>
