<%-- 
    ...
    Created on : 1 Mar, 2024, 12:11:46 PM
   ...
   <body class="main-layout">
      ...
      <div  class="about">
            ...
            <div class="container" >
               <div class="row" >
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img" >
                        <div class="about_box" >
                           <h3 colspan='5'>FeedBack Report</h3>
                           
                           <form>
                               <table border="2" align="center" height="250px" width="600px" style="background-color: #ffffff">
                                   ...
                                   <tbody>
                                       ...
                                       <tr>
                                           <td>Name</td><td>Email</td><td>Feedback</td>
                                       </tr>
                                       <%
                                         String nm=null;
                                        String email=null;
       ...
       { 
          ...
          feedb=rs.getString(3);
                                       %>
                                       <tr><td><%=nm%></td><td><%=email%></td><td><%=feedb%></td>      
                                       </tr>                                     
                                           <%
       }
