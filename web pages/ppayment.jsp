<%-- 
    Document   : ppayment
    Created on : 10 Oct, 2023, 12:38:27 AM
...
<html lang="en">
   ...
   <body class="main-layout">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img">
                        <div class="about_box">
                           <h3 colspan='5'>Payment</h3>
                           
                           <form>
                               <table border="2" align="center" width="350px" height="200px"  style="background-color: #ffffff">
                                   <tbody>
                                       <tr>
                                           <td>Booking Id</td>
                                           <td><%=mn1%></td>
                                     ...
                                     <%
                                       ...
                                       Statement st=con.createStatement();
                                        String str="select * from finalbooking where id="+mn1+"";
                      ...
                      amt=rate*kms;
                               ...
                               %>
                                       ...
                                       <tr>
                                           <td colspan="5" align="center"><a href="cash.jsp">Cash on Pay</td>
                                           
                                       </tr>
                                       
                                        <tr>
                                            <td colspan="5" align="center"><a href="online.jsp">Online Pay</td>
      ...
      if(bd!=null && bd!="" && fnm!=null && fnm!="" && mob!=null && mob!="" && vtype!=null && vtype!="" )
       {
      String str2="insert into ppayment(id,booking_date,Full_name,mobile_number,vehicle_type,kms,rent)values("+mn1+",'"+bd+"','"+fnm+"',"+mob+",'"+vtype+"',"+kms+","+amt+")";
