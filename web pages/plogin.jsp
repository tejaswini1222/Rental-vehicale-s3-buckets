<%-- 
    Document   : plogin
    Created on : 6 Oct, 2023, 1:28:17 PM
...
<html lang="en">
   ...
   <body class="main-layout">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              <li class="nav-item active">
                               ...
                               <li class="nav-item">
                                   <a class="nav-link" href="pregistration.jsp">Registration</a>
                              </li>
                              <li class="nav-item">
      ...
      <div  class="about">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img">
                        <div class="about_box">
                           <h3 colspan='5'>Passenger Login</h3>
                           
                           <form>
                               <table border="2" align="center" width="300px" height="150px"  style="background-color: #ffffff">
                                   <tbody>
                                       <tr>
                                           <th>Username</th>
                                           <th><input type="text" name="txtpnm" value="" /></th>
                                       </tr>
       ...
       if(pnm!=null && null!="" && pass!=null && pass!="" )
       {
       String str="select * from pregister where Username='"+pnm+"' and Password='"+pass+"'";
       ResultSet rs=st.executeQuery(str);
       if(rs.next())
       {
            out.println("<script>alert('Passenger Login Sucess......')</script>");
            session.setAttribute("pnm1", pnm);
            response.sendRedirect("phomepage.jsp");
       }
       else
       {
           out.println("<script>alert('Passenger Login Failed......')</script>");
       }
       } 
