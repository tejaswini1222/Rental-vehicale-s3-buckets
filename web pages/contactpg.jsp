<%-- 
    Document   : contactpg
    Created on : 12 Oct, 2023, 10:57:11 AM
                               ...
                               <table border="2" align="center" height="250px" width="350px" style="background-color: #ffffff">
                                    <tbody>
                                       <tr>
                                           ...
                                           <th><input type="text" name="name" value="Rental Vehical Services " /></th>
                                       </tr>
                                   
                                   
                                       <tr>
                                           <td>Email</td>
                                           <td><input type="text" name="email" value="renataleService123@.gail.com" /></td>
                                       </tr>
                                       <tr>
                                           <td>Contact Number</td>
                                           <td><input type="text" name="contact number" value="7020153031" /></td>
