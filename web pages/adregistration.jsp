<%-- 
    Document   : asignin
    Created on : 10 Oct, 2023, 12:42:25 AM
...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <div  class="about">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img">
                        <div class="about_box">
                           <h3 colspan='5'>Admin Registeration</h3>
       ...
       {
       String str="insert into adregist(Full_name,Mobile_no,Address,Email,username,password)values('"+nm+"',"+mob+",'"+add+"','"+email+"','"+unm+"','"+pass+"')";
