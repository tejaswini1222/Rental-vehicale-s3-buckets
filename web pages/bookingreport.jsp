<%-- 
    Document   : report
    Created on : 1 Mar, 2024, 11:52:14 AM
...
<html lang="en">
   ...
   <body class="main-layout">
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                    <a class="nav-link" href="bookingreport.jsp">Booking Report</a>
                              </li>
                              <li class="nav-item">
                                  <a class="nav-link" href="addvehireport.jsp">Vehicle Report</a>
                              </li>
                              <li class="nav-item">
                                  <a class="nav-link" href="registreport.jsp">Registration Report</a>
                              </li>
                             <li class="nav-item">
                                 <a class="nav-link" href="feedbackreport.jsp">Feedback Report</a>
                              </li>
                              <li class="nav-item">
      ...
      <div  class="about">
            ...
            <div class="container" >
               <div class="row" >
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img" >
                        <div class="about_box" >
                            <h3 colspan='5'><center>Booking Report</center></h3>
                           
                           <form>
                               <table border="2" align="center" height="250px" width="50px" style="background-color: #ffffff">
                                   ...
                                   <tbody>
                                       ...
                                       <tr>
                                           <td>Booking Id</td><td>Booking Date</td><td>Full Name</td><td>Mobile Number</td><td>Vehicle Id</td><td>Vehicle Types</td><td>Vehicle Company</td><td>Model Type</td><td>Oil Type</td><td>Rate of vehicle</td><td>km to reach</td><td>Total Seats</td><td>Return Date</td><td>UserName</td>
                                       </tr>
                                       <%
       ...
       String str="select * from finalbooking";
       ...
       {   id=rs.getInt(1);
          bd1=rs.getString(2);
           ...
           kms=rs.getString(11);
           seat=rs.getInt(12);
           retd=rs.getString(13);
           unm=rs.getString(14);
       
                                       %>
                                       <tr><td><%=id%></td><td><%=bd1%></td><td><%=fnm%></td><td><%=mob%></td><td><%=vid%></td><td><%=vtype%></td><td><%=vcom%></td><td><%=modt%></td><td><%=otype%></td><td><%=rate%></td><td><%=kms%></td><td><%=seat%></td><td><%=retd%></td><td><%=unm%></td></tr>
                                       <%
       }
       %>
