<%-- 
    ...
    Created on : 17 Jan, 2024, 10:32:30 AM
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                  <a class="nav-link" href="psearchvehi.jsp">Search Vehicle</a>
                              </li>
                              <li class="nav-item">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img">
                        <div class="about_box">
                           <h3 colspan='5'>Book Vehical</h3>
                           
                           
                           
                           <form >
                               <table  align="center" border="2.5" width='580px' style="background-color: #ffffff">
                                    <tbody >                               
                                       <tr>
                                           <th>Booking Id</th>
                                           <th><%=mn1%></th>
                                    ...
                                    <%
                                       ...
                                       Statement st=con.createStatement();
                                        String str="select * from pbooking where booking_id="+mn1+"";
                               ...
                               %>
                                       <tr>
                                           <td>Booking Date</td>
                                           <td><input type="date" name="txtbd" value="" /></td>
                                       </tr>
                                      ...
                                      <tr>
                                           <td>Rate of vehicle</td>
                                           <td><%=rent%></td>
                                       </tr>
                                        <tr>
                                           <td>KMs to Reach</td>
                                           <td><input type="text" name="txtkm" value="" /></td>
                                       </tr>
                                       
                                       
                                       <tr>
                                           <td>Total Seats</td>
                                           <td><input type="text" name="txtseat" value="" /></td>
                                       </tr>
                                       
                                       <tr>
                                           <td>Return Date</td>
                                           <td><input type="date" name="txtretd" value="" /></td>
                                       </tr>
                                        <tr>
                                           <td>UserName</td>
                                           <td><%=pnm%></td>
                                       ...
                                       <tr>
                                           <td colspan="7" align="center"><input type="submit" value="Book" name="Book" /></td>
                                           
                                              
                                       </tr>
                                       <tr>
                                           <td colspan="5" align="center"><a href="ppayment.jsp">Next</td>
                                    ...
                                    <%
                                      ...
                                      bd=request.getParameter("txtbd");
                                      seat=request.getParameter("txtseat");
                                      km=request.getParameter("txtkm");
                                     retd=request.getParameter("txtretd");
                                                                                         
       Statement st3=con.createStatement();
      // if(bd!=null && bd!="" && fnm!=null && fnm!="" && mob!=null && mob!="" && vtype!=null && vtype!="" && vcom!=null && vcom!="" && modt!=null && modt!="" && seat!=null && seat!="" && retd!=null && retd!="" && pnm!=null && pnm!="" )
      if(bd!=null && bd!="" && seat!=null && seat!="" && km!=null && km!="")
       {
       String str3="insert into finalbooking(id,Booking_date,Full_name,Mobile_number,Vehical_id,Vehical_type,Vehical_Company,Model_type,oil_type,rent_vehical,kms,Total_seat,Return_date,Username)values("+mn1+",'"+bd+"','"+fnm+"',"+mob+","+vid+",'"+vtype+"','"+vcom+"','"+modt+"','"+otype+"','"+rent+"',"+km+","+seat+",'"+retd+"','"+pnm+"')";
       int a=st3.executeUpdate(str3);
       out.println("<script>alert('Booking sucessfully......')</script>");     
       }
                       %>   
