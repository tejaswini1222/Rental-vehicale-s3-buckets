<%-- 
    Document   : pbookvehi
    Created on : 7 Oct, 2023, 11:42:22 AM
...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <div  class="about">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img">
                        <div class="about_box">
                           <h3 colspan='5'>Processes of Book Vehical</h3>
       ...
       String str1="select count(*) from pbooking ";
       ...
       if(rs1.next())
       {
           ...
           i++;
                                       ...
                                       String mob= null;
                                        ...
                                        String str2="select * from pregister where Username='"+pnm+"'";
                                       ...
                                       <tr>
                                        ...
                                        String str="select * from avehiclinfo where Id="+id1+"";
                               ...
                               %>
                                      ...
                                      <tr>
                                       ...
                                       <tr>
                                           <td colspan="5" align="center"><a href="finalbooking.jsp">Next</td>
      ...
      // if(fnm!=null && fnm!="" && mob!=null && mob!="" && vtype!=null && vtype!="" && vcom!=null && vcom!="" && modt!=null && modt!="" )
       //{
       String str3="insert into pbooking(booking_id,Full_name,Mobile_number,Vehical_id,Vehical_type,Vehical_Company,Model_type,oil_type,rent_vehical,unit)values("+i+",'"+fnm+"',"+mob+","+id1+",'"+vtype+"','"+vcom+"','"+modt+"','"+otype+"','"+rent+"','"+unit+"')";
       int a=st3.executeUpdate(str3);
      // out.println("<script>alert('Procceses Booking......')</script>");  
        out.println("Procceses Booking......");  
      // }
      
        
        
        String mn1=String.valueOf(i);
       
        session.setAttribute("mn2", mn1);
