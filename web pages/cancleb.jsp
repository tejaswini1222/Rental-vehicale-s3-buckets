<%-- 
    Document   : cancleb
    Created on : 9 Oct, 2023, 12:21:25 AM
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img">
                        <div class="about_box">
                           <h3 colspan='5'>Cancle Booking</h3>
                           
                           <form>
                               <table border="2.5" width='600px' height='350px' style="background-color: #ffffff">
                                   <tbody>
                                        <%
                                         String vcom= null;
                                         int bid= 0;
                                       ...
                                       Statement st=con.createStatement();
                                        String str="select * from finalbooking where id="+bid1+"";
                               ...
                               %>
                                   ...
                                   <tr>
                                       ...
                                       <tr>
                                           ...
                                           <td>Reason</td>
                                           <td><input type="text" name="txtres" value="" /></td>
                                       </tr>
                                       <tr>
                                           <td colspan="2" align='center'><input type="submit" value="Cancle" name="Cancle" /></td>
                                           
                                       </tr>
                                         <%
                                     String res=null;
                                         
                                      res=request.getParameter("txtres");
                                     
                                                                                         
       Statement st1=con.createStatement();
       if(fnm!=null && fnm!="" && bdate!=null && bdate!="" && vtype!=null && vtype!="" && vcom!=null && vcom!="" && res!=null && res!="" )
       {
       String str1="insert into cancle_booking(Full_name,Booking_id,Booking_date,,Vehical_id,Vehical_type,Vehical_Company,Reason)values('"+fnm+"',"+bid+",'"+bdate+"',"+vid+",'"+vtype+"','"+vcom+"','"+res+"')";
       int a=st1.executeUpdate(str1);
       out.println("<script>alert('Booking Cancel sucessfully......')</script>");   
       }
                       %>   
                                   </tbody>
                               </table>
