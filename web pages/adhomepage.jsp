<%-- 
    Document   : adhomepage
    Created on : 11 Oct, 2023, 1:16:45 PM
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                  <a class="nav-link" href="registreport.jsp">Report</a>
                              </li>
                              <li class="nav-item">
                  ...
                  <div class="col-md-10 offset-md-1">
                   <div class="about_img">
                        <div class="about_box">
                           ...
                           <p>      We developed this application to book a car on rent at the fare charges.In present system all
                               booking work done manually and it takes very hard work to maintain the information of booking and cars. If you want to find which vehicle is available for booking 
                               then it takes a lot of time. It only makes the process more difficult and hard. This aim of the application is to automate the work performed in the
                               all vehicles rental management system like generating daily bookings, records of car or cab available for booking.You can pay using debit or credit 
                               cards or you can also pay by cash for our service.Our system also give facility of panic Button for emergency purpose. Our vehicle rental management 
                               system provides a total solution to the field of auto rental industry. The idea behind the proposed website is to develop a system that allows customers 
                               to rent any vehicle as per their needs on the selected date for required time and in any of the selected cities.
                           </p>
                        </div>
<!--                     </div>-->
                  </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 margin_boot">
                                       <div class="test_box">
                                          ...
                                          <h4>RANI</h4>
                                          <span>(Pune)</span>
                                          <p>I had a positive experience with the vehicle rental service. The vehicle was clean, and the staff was helpful and accommodating. However, I suggest implementing a more user-friendly online reservation system 
                                          </p>
                                       </div>
                                    </div>
                                 </div>
