<%-- 
    Document   : registreport
    Created on : 1 Mar, 2024, 11:58:50 AM
...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <div  class="about">
            ...
            <div class="container" >
               <div class="row" >
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img" >
                        <div class="about_box" >
                           <h3 colspan='5'>Registration Report</h3>
                           ...
                           <form>
                               <table border="2" align="center" height="250px" width="50px"  style="background-color: #ffffff">
                                   ...
                                   <tbody>
                                           ...
                                           <td>Serial Number</td><td>Full Name</td><td>Mobile Number</td><td>Email</td><td>Address</td><td>Age</td><td>Gender</td><td>Username</td><td>Password</td>
                                       </tr>
                                       <%
                                        int i=0;
                                        String fnm=null;
       ...
       String str="select * from pregister";
       ...
       {  
          ...
          pass=rs.getString(9);
                                       %>
                                       <tr><td><%=i%></td><td><%=fnm%></td><td><%=mob%></td><td><%=email%></td><td><%=add%></td><td><%=age%></td><td><%=gen%></td><td><%=unm%></td><td><%=pass%></td> 
                                       </tr>
