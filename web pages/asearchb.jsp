<%-- 
    Document   : asearchb
    Created on : 11 Oct, 2023, 12:58:25 PM
...
<html lang="en">
   ...
   <body class="main-layout">
      ...
      <div  class="about">
            ...
            <div class="container" >
               <div class="row" >
                  <div class="col-md-10 offset-md-1">
                     <div class="about_img" >
                        <div class="about_box" >
                           <h3 colspan='5'>Search Booking</h3>
                           ...
                           <form>
                               <table border="2" align="center" height="250px" width="50px" style="background-color: #ffffff">
                                   ...
                                   <tbody>
                                       ...
                                       <tr>
                                           <td>Booking Date</td>
                                           <td><input type="date" name="txtbd" value=""style="width:100px"></td>
                                       </tr>
                                       <td colspan="12" align="center"><input type="submit" value="Search" name="Search" /></td>
                                           
                                       <tr>
                                           <td>Booking Id</td><td>Booking Date</td><td>Full Name</td><td>Mobile Number</td><td>Vechical Id</td><td>Vehical Types</td><td>Vehical Company</td><td>Model Type</td><td>Oil Type</td><td>Total Seats</td><td>Return Date</td>
                                       </tr>
                                       <%
       ...
       String str="select * from finalbooking where Booking_date='"+bd+"'";
       ...
       {   id=rs.getInt(1);
          bd1=rs.getString(2);
           ...
           seat=rs.getInt(10);
           retd=rs.getString(11);
       
                                       %>
                                       <tr><td><%=id%></td><td><%=bd1%></td><td><%=fnm%></td><td><%=mob%></td><td><%=vid%></td><td><%=vtype%></td><td><%=vcom%></td><td><%=modt%></td><td><%=otype%></td><td><%=seat%></td><td><%=retd%></td></tr>
                                       <%
       }
       %>
