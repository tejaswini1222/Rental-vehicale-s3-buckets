<%-- 
    Document   : feedback
    Created on : 11 Oct, 2023, 1:32:17 PM
...
<!DOCTYPE html>
   ...
   <body class="main-layout">
       <%
           ...
           feedb=request.getParameter("txtfeedb");
                           ...
                           <form>
                               <table border="2" align="center" height="250px" width="350px" style="background-color: #ffffff">
                                    <tbody>
                                       <tr>
                                           <th>Name</th>
                                           <th><input type="text" name="txtnm" value="" /></th>
                                       </tr>
                                       ...
                                       <tr>
                                           <td>Feedback</td>
                                           <td><textarea name="txtfeedb" rows="4" cols="20">
                                               </textarea></td>
      ...
      if(nm!=null && nm!="" && email!=null && email!="" && feedb!=null && feedb!="" )
      {
        String str= "insert into feedback(name,email,feedback)values('"+nm+"','"+email+"','"+feedb+"')";
        int a=st.executeUpdate(str);
        out.println("<script>alert('Thanks for Feedback......')</script>");
